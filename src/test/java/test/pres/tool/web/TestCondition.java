...
public class TestCondition {
	...
	public void test_01_Condition() {
		Condition c = new Condition("html", ConstraintType.NUMBER, "[1, 2]");
		c = new Condition("html", ConstraintType.NUMBER, "[0.31, 2.55]");
		c = new Condition("html", ConstraintType.DATE, "[2019.3.5, 2019-6.4]");
		c = new Condition("html", ConstraintType.DATE, "[2019.3.5 11:13:25, 2019-6.4 5:5]");
		c = new Condition("html", ConstraintType.DATE, "[2019年3月5日 11:13:25, 2019-6.4 5:5]");
		c = new Condition("html", ConstraintType.DATE, "[2019年3月5日 11时13分25秒, 2019年6月4 15时15分15]");
		
		try {
			c = new Condition("html", ConstraintType.DATE, "[2sdfgbsdhbs秒, 2019u6d4 15g15h15]");
		} catch (Exception e) {
			e.printStackTrace();
		}
		try {
			c = new Condition("html", ConstraintType.NUMBER, "[w, d]");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void test_02_constraintsNumber() {
		try {
			...
			//参数类型数组
			Class[] parameterTypes={String.class, ConstraintType.class, String[].class};
			//根据参数类型获取相应的构造函数
			Constructor constructor=clazz.getConstructor(parameterTypes);
			//参数数组
			Object[] parameters={"html", ConstraintType.NUMBER, new String[] {"[1, 2]", "(0.3, 5)", "[0.1, 0.6)", "(6, 0.8]"}};
			//根据获取的构造函数和参数，创建实例
	...
	public void test_03_constraintsDate() {
		try {
			...
			Constructor constructor=clazz.getConstructor(parameterTypes);
			//参数数组
			Object[] parameters={"html", ConstraintType.DATE, new String[] {
	...
	public void test_04_isConformToConstraint_number() {
		Condition c = new Condition("html", ConstraintType.NUMBER, "(0.1, 0.5)", "[2, 4]", "[4.2, 6)", "(10, 7.5]");
	...
	public void test_05_isConformToConstraint_date() {
		Condition c = new Condition("html", ConstraintType.DATE, "(2019-1-1, 2019-1-5)", "[2019-2-1, 2019-2-5]", "[2019-3-1, 2019-3-5)", "(2019-4-5, 2019-4-1]");
	...
	public void test_06_isConformToConstraint_string() {
		Condition c = new Condition("html", ConstraintType.STRING, "a", "b", "ab", "abc");
