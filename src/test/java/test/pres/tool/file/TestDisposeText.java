...
//		DisposeText.compareFileWord(testFile, targetFile);
	...
	public void test_02_textDelDuplication() throws IOException {
		System.out.println(DisposeText.textDelDuplication(new File("src/test/java/test/pres/tool/file/ÐÕÃû.xlsx")));
	}
...
//		File testFile = new File("src/test/java/test/pres/tool/file/test.txt");
		File testFile = new File("D:\\4.download\\¹È¸èÏÂÔØ\\¹È¸è×Ô¶¯»¯²âÊÔÏÂÔØ\\ÐÂ½¨ÎÄ±¾ÎÄµµ.txt");
